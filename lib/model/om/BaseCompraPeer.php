...
abstract class BaseCompraPeer {
	...
	const CLIENTEID = 'compra.CLIENTEID';
	...
	/**
	 * An identiy map to hold any loaded instances of Compra objects.
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Idcompra', 'Cantidad', 'Fecha', 'Clienteid', 'Productoid', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idcompra', 'cantidad', 'fecha', 'clienteid', 'productoid', ),
		BasePeer::TYPE_COLNAME => array (self::IDCOMPRA, self::CANTIDAD, self::FECHA, self::CLIENTEID, self::PRODUCTOID, ),
		BasePeer::TYPE_RAW_COLNAME => array ('IDCOMPRA', 'CANTIDAD', 'FECHA', 'CLIENTEID', 'PRODUCTOID', ),
		BasePeer::TYPE_FIELDNAME => array ('idcompra', 'cantidad', 'fecha', 'clienteid', 'productoid', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Idcompra' => 0, 'Cantidad' => 1, 'Fecha' => 2, 'Clienteid' => 3, 'Productoid' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idcompra' => 0, 'cantidad' => 1, 'fecha' => 2, 'clienteid' => 3, 'productoid' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::IDCOMPRA => 0, self::CANTIDAD => 1, self::FECHA => 2, self::CLIENTEID => 3, self::PRODUCTOID => 4, ),
		BasePeer::TYPE_RAW_COLNAME => array ('IDCOMPRA' => 0, 'CANTIDAD' => 1, 'FECHA' => 2, 'CLIENTEID' => 3, 'PRODUCTOID' => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('idcompra' => 0, 'cantidad' => 1, 'fecha' => 2, 'clienteid' => 3, 'productoid' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(CompraPeer::CANTIDAD);
			$criteria->addSelectColumn(CompraPeer::FECHA);
			$criteria->addSelectColumn(CompraPeer::CLIENTEID);
			$criteria->addSelectColumn(CompraPeer::PRODUCTOID);
		} else {
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseCompraPeer', $criteria, $con);
		}
	 ...
	 *
	 * @param      Compra $value A Compra object.
	...
	public static function doCountJoinCliente(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(CompraPeer::CLIENTEID, ClientePeer::IDCLIENTE, $join_behavior);
	...
	public static function doCountJoinProducto(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(CompraPeer::PRODUCTOID, ProductoPeer::IDPRODUCTO, $join_behavior);
	...
	/**
	 * Selects a collection of Compra objects pre-filled with their Cliente objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinCliente(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Compra) to $obj2 (Cliente)
				$obj2->addCompra($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Compra) to the collection in $obj2 (Cliente)
				$obj2->addCompra($obj1);
	...
	/**
	 * Selects a collection of Compra objects pre-filled with all related objects except Cliente.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseCompraPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
