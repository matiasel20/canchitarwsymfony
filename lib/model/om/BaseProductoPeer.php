...
abstract class BaseProductoPeer {
	...
	/** the column name for the TAMANIO field */
	const TAMANIO = 'producto.TAMANIO';
	...
	/** the column name for the CATEGORIAID field */
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Idproducto', 'Codigo', 'Descripcion', 'Modelo', 'Tamanio', 'Precio', 'Stock', 'Categoriaid', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idproducto', 'codigo', 'descripcion', 'modelo', 'tamanio', 'precio', 'stock', 'categoriaid', ),
		BasePeer::TYPE_COLNAME => array (self::IDPRODUCTO, self::CODIGO, self::DESCRIPCION, self::MODELO, self::TAMANIO, self::PRECIO, self::STOCK, self::CATEGORIAID, ),
		BasePeer::TYPE_RAW_COLNAME => array ('IDPRODUCTO', 'CODIGO', 'DESCRIPCION', 'MODELO', 'TAMANIO', 'PRECIO', 'STOCK', 'CATEGORIAID', ),
		BasePeer::TYPE_FIELDNAME => array ('idproducto', 'codigo', 'descripcion', 'modelo', 'tamanio', 'precio', 'stock', 'categoriaid', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Idproducto' => 0, 'Codigo' => 1, 'Descripcion' => 2, 'Modelo' => 3, 'Tamanio' => 4, 'Precio' => 5, 'Stock' => 6, 'Categoriaid' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idproducto' => 0, 'codigo' => 1, 'descripcion' => 2, 'modelo' => 3, 'tamanio' => 4, 'precio' => 5, 'stock' => 6, 'categoriaid' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::IDPRODUCTO => 0, self::CODIGO => 1, self::DESCRIPCION => 2, self::MODELO => 3, self::TAMANIO => 4, self::PRECIO => 5, self::STOCK => 6, self::CATEGORIAID => 7, ),
		BasePeer::TYPE_RAW_COLNAME => array ('IDPRODUCTO' => 0, 'CODIGO' => 1, 'DESCRIPCION' => 2, 'MODELO' => 3, 'TAMANIO' => 4, 'PRECIO' => 5, 'STOCK' => 6, 'CATEGORIAID' => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('idproducto' => 0, 'codigo' => 1, 'descripcion' => 2, 'modelo' => 3, 'tamanio' => 4, 'precio' => 5, 'stock' => 6, 'categoriaid' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(ProductoPeer::TAMANIO);
			$criteria->addSelectColumn(ProductoPeer::PRECIO);
			$criteria->addSelectColumn(ProductoPeer::STOCK);
			$criteria->addSelectColumn(ProductoPeer::CATEGORIAID);
		} else {
			...
			$criteria->addSelectColumn($alias . '.TAMANIO');
			$criteria->addSelectColumn($alias . '.PRECIO');
			$criteria->addSelectColumn($alias . '.STOCK');
			$criteria->addSelectColumn($alias . '.CATEGORIAID');
		}
	}
	...
	public static function doCountJoinCategoria(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ProductoPeer::CATEGORIAID, CategoriaPeer::IDCATEGORIA, $join_behavior);
